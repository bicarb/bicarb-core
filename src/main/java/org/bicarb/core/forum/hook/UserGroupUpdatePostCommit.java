...
/**
 * UserGroupUpdatePostCommit, expire session to force user re-login.
 *
 * @author olOwOlo
 */
@ElideHook(lifeCycle = OnUpdatePostCommit.class, fieldOrMethodName = "group")
public class UserGroupUpdatePostCommit implements LifeCycleHook<User> {

  private final BicarbSessionRegistry sessionRegistry;

  @Autowired
  public UserGroupUpdatePostCommit(BicarbSessionRegistry sessionRegistry) {
