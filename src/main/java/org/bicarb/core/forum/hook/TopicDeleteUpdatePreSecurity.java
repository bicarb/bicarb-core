...
/**
 * Topic Delete UpdatePreSecurity.
 *
 * @author olOwOlo
 */
@ElideHook(lifeCycle = OnUpdatePreSecurity.class, fieldOrMethodName = "delete")
public class TopicDeleteUpdatePreSecurity implements LifeCycleHook<Topic> {

  private final UserRepository userRepository;

  @Autowired
  public TopicDeleteUpdatePreSecurity(UserRepository userRepository) {
    this.userRepository = userRepository;
  }

  @Override
  public void execute(Topic topic, RequestScope requestScope, Optional<ChangeSpec> changes) {
    topic.setDeleteBy(userRepository.getOne(AuthenticationUtils.fetchUserId(requestScope)));
  }
}
